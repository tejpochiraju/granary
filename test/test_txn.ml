  ...
  Alcotest.run "test_txn"
    [ "begin_commit", [
      ...
      "execute_change_count", [
        ...
        Alcotest.test_case "commit_no_txn_error"  `Quick test_execute_change_count_begin_error_no_txn;
        Alcotest.test_case "double_begin_error"   `Quick test_execute_change_count_double_begin_error;
        Alcotest.test_case "update_delete_in_txn" `Quick test_execute_change_count_update_in_txn;
