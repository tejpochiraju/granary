...
USER opam
RUN opam install -y lwt cstruct menhir alcotest qcheck-alcotest lwt_ppx mirage-block mirage-block-unix uutf uucp mirage-crypto mirage-crypto-rng mirage-crypto-rng-lwt alcotest-lwt
